...
3$:
        ...
        VM_RPN
            ...
            .R_OPERATOR .DIV
            .R_STOP
        VM_SET                  VAR_S1A0_LOCAL_0, .ARG1
        VM_SET                  VAR_S1A0_LOCAL_1, .ARG0
        VM_POP                  2

        ; If abs(VAR_VARIABLE_3-VAR_S1A0_LOCAL_0)+abs(VAR_VARIABLE_4-VAR_S1A0_LOCAL_1)==2
        VM_RPN
            .R_REF      VAR_VARIABLE_3
            .R_REF      VAR_S1A0_LOCAL_0
            .R_OPERATOR .SUB
            .R_OPERATOR .ABS
            .R_REF      VAR_VARIABLE_4
            .R_REF      VAR_S1A0_LOCAL_1
            .R_OPERATOR .SUB
            .R_OPERATOR .ABS
            .R_OPERATOR .ADD
            .R_INT16    2
...
17$:
        ...
        VM_SET                  VAR_S1A0_LOCAL_2, ^/(.LOCAL_ACTOR + 1)/

        VM_SET_CONST            .LOCAL_ACTOR, 1
        ; Store Frame In Variable
        VM_ACTOR_GET_ANIM_FRAME .LOCAL_ACTOR
        VM_SET                  VAR_S1A0_LOCAL_3, ^/(.LOCAL_ACTOR + 1)/

        ; If VAR_S1A0_LOCAL_2+VAR_S1A0_LOCAL_3==5
        VM_RPN
            .R_REF      VAR_S1A0_LOCAL_2
            .R_REF      VAR_S1A0_LOCAL_3
            .R_OPERATOR .ADD
            .R_INT16    5
            .R_OPERATOR .EQ
            .R_STOP
...
22$:
        ...
        ; Store Frame In Variable
        VM_ACTOR_GET_ANIM_FRAME .LOCAL_ACTOR
        VM_SET                  VAR_S1A0_LOCAL_0, ^/(.LOCAL_ACTOR + 1)/

        ; Variable L0 = VAR_S1A0_LOCAL_0+6
        VM_RPN
            .R_REF      VAR_S1A0_LOCAL_0
            .R_INT16    6
            .R_OPERATOR .ADD
            .R_STOP
        VM_SET                  VAR_S1A0_LOCAL_0, .ARG0
        VM_POP                  1
