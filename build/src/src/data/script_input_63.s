...
___bank_script_input_63 = 255
.globl ___bank_script_input_63
...
_script_input_63::
        ...
        VM_SET                  VAR_S11_LOCAL_4, ^/(.LOCAL_ACTOR + 1)/

        VM_SET_CONST            .LOCAL_ACTOR, 1
        ; Store Frame In Variable
        VM_ACTOR_GET_ANIM_FRAME .LOCAL_ACTOR
        VM_SET                  VAR_S11_LOCAL_5, ^/(.LOCAL_ACTOR + 1)/
...
3$:
        ...
        ; Variable Copy
        VM_SET                  VAR_ANIMATION_FRAME, VAR_S11_LOCAL_5
        ...
        VM_SET                  ^/(.LOCAL_ACTOR + 1)/, VAR_S11_LOCAL_5
        ...
        ; Actor Set Animation Frame To Variable
        VM_SET                  ^/(.LOCAL_ACTOR + 1)/, VAR_S11_LOCAL_4
        VM_ACTOR_SET_ANIM_FRAME .LOCAL_ACTOR
