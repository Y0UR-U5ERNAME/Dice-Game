...
19$:
        ; Input Script Attach
        VM_CONTEXT_PREPARE      5, ___bank_script_input_106, _script_input_106
        VM_INPUT_ATTACH         15, ^/(5 | .OVERRIDE_DEFAULT)/

        ; Input Script Attach
        VM_CONTEXT_PREPARE      4, ___bank_script_input_107, _script_input_107
...
22$:
        ...
        VM_PUSH_CONST           VAR_S14A0_LOCAL_1 ; Variable V1
        VM_PUSH_CONST           VAR_S14A0_LOCAL_0 ; Variable V0
        VM_CALL_FAR             ___bank_script_3, _script_3

        ; Input Script Attach
        VM_CONTEXT_PREPARE      4, ___bank_script_input_108, _script_input_108
        VM_INPUT_ATTACH         16, ^/(4 | .OVERRIDE_DEFAULT)/
