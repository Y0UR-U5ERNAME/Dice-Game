...
_script_input_19::
        ...
        VM_RPN
            ...
            .R_OPERATOR .DIV
            .R_STOP
        VM_SET                  VAR_S3_LOCAL_0, .ARG1
        VM_SET                  VAR_S3_LOCAL_1, .ARG0
        VM_POP                  2
        ...
        VM_RPN
            ...
            .R_OPERATOR .DIV
            .R_STOP
        VM_SET                  VAR_S3_LOCAL_2, .ARG1
        VM_SET                  VAR_S3_LOCAL_3, .ARG0
        VM_POP                  2

        ; Variable Set To True
        VM_SET_CONST            VAR_MOVING, 1

        ; Variable T0 = VAR_S3_LOCAL_0-1
        VM_RPN
        ...
        VM_GET_TILE_XY          VAR_S3_LOCAL_4, VAR_TEMP_0, VAR_TEMP_1
        ; If VAR_S3_LOCAL_4%256>25
        VM_RPN
            .R_REF      VAR_S3_LOCAL_4
            .R_INT16    256
            .R_OPERATOR .MOD
            .R_INT16    25
            .R_OPERATOR .GT
...
3$:
        ...
        VM_SET                  VAR_S3_LOCAL_0, ^/(.LOCAL_ACTOR + 1)/
...
8$:
        ...
        ; Variable L0 = (VAR_S3_LOCAL_0+1)%6
        VM_RPN
            .R_REF      VAR_S3_LOCAL_0
            .R_INT16    1
            .R_OPERATOR .ADD
        ...
        VM_SET                  ^/(.LOCAL_ACTOR + 1)/, VAR_S3_LOCAL_0
        VM_ACTOR_SET_ANIM_FRAME .LOCAL_ACTOR

        VM_JUMP                 6$
5$:
        ; Variable T0 = VAR_S3_LOCAL_2-1
        VM_RPN
            .R_REF      VAR_S3_LOCAL_2
            .R_INT16    1
            .R_OPERATOR .SUB
