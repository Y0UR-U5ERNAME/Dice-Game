...
___bank_script_input_93 = 255
.globl ___bank_script_input_93
...
_script_input_93::
        ...
        VM_RPN
            ...
            .R_OPERATOR .DIV
            .R_STOP
        VM_SET                  VAR_S15_LOCAL_0, .ARG1
        VM_SET                  VAR_S15_LOCAL_1, .ARG0
        VM_POP                  2
        ...
        VM_RPN
            ...
            .R_OPERATOR .DIV
            .R_STOP
        VM_SET                  VAR_S15_LOCAL_2, .ARG1
        VM_SET                  VAR_S15_LOCAL_3, .ARG0
        VM_POP                  2

        ; Variable Set To True
        VM_SET_CONST            VAR_MOVING, 1

        ; Variable T0 = VAR_S15_LOCAL_0+2
        VM_RPN
            .R_REF      VAR_S15_LOCAL_0
            .R_INT16    2
            .R_OPERATOR .ADD
            .R_STOP
        ...
        ; Variable T1 = VAR_S15_LOCAL_1-1
        VM_RPN
            .R_REF      VAR_S15_LOCAL_1
            .R_INT16    1
            .R_OPERATOR .SUB
            .R_STOP
        ...
        VM_GET_TILE_XY          VAR_S15_LOCAL_4, VAR_TEMP_0, VAR_TEMP_1
        ; If VAR_S15_LOCAL_4%256>25&&VAR_S15_LOCAL_0!=6
        VM_RPN
            .R_REF      VAR_S15_LOCAL_4
            .R_INT16    256
            .R_OPERATOR .MOD
            .R_INT16    25
            .R_OPERATOR .GT
        ...
        VM_JUMP                 4$
3$:
        ; If $Local1==$Local3&&$Local0+2==$Local2
        VM_RPN
        ...
        VM_SET                  VAR_S15_LOCAL_0, ^/(.LOCAL_ACTOR + 1)/

        ; Variable 1 = (VAR_S15_LOCAL_0+1)%6
        VM_RPN
            .R_REF      VAR_S15_LOCAL_0
            .R_INT16    1
            .R_OPERATOR .ADD
...
8$:
        ...
        ; Variable L0 = (VAR_S15_LOCAL_0+1)%6
        VM_RPN
            .R_REF      VAR_S15_LOCAL_0
            .R_INT16    1
            .R_OPERATOR .ADD
        ...
        VM_SET                  ^/(.LOCAL_ACTOR + 1)/, VAR_S15_LOCAL_0
        VM_ACTOR_SET_ANIM_FRAME .LOCAL_ACTOR

        VM_JUMP                 6$
5$:
        ; Variable T0 = VAR_S15_LOCAL_2+2
        VM_RPN
            .R_REF      VAR_S15_LOCAL_2
            .R_INT16    2
            .R_OPERATOR .ADD
            .R_STOP
        VM_SET                  VAR_TEMP_0, .ARG0
        ...
        ; Variable T1 = VAR_S15_LOCAL_3-1
        VM_RPN
            .R_REF      VAR_S15_LOCAL_3
            .R_INT16    1
            .R_OPERATOR .SUB
            .R_STOP
        VM_SET                  VAR_TEMP_1, .ARG0
...
15$:
        ...
        ; If Variable True
        VM_IF_CONST             .GT, VAR_ROLL_ANIMATION, 0, 17$, 0
        ; Actor Set Active
        VM_SET_CONST            .LOCAL_ACTOR, 0
